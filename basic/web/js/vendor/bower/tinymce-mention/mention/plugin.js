    ...
    tinymce.create('tinymce.plugins.Mention', {
        ...
        init: function (ed) {
            ...
            ed.on('keypress', function (e) {
                ...
                //prevCharIsSpace()
                if(String.fromCharCode(e.which || e.keyCode) !=  "undefined"){
                    string +=  String.fromCharCode(e.which || e.keyCode);
                }
              ...
              if(string.length > 1 && findPartial( entitiesArr, string )){
                  autoCompleteData.delimiter.push(string);
              }

                var delimiterIndex = $.inArray(string , autoCompleteData.delimiter);
